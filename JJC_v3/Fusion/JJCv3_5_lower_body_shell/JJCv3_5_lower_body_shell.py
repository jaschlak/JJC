"""Create the JJC V3 lower hollow body shell."""
...
def run(_context):
    ...
    try:
        ...
        if not isinstance(design, adsk.fusion.Design):
            ...
            return
        body = jjc_v3_parts.create_lower_body_shell(design.rootComponent)
        ui.activeSelections.clear()
        ui.activeSelections.add(body)
        ui.messageBox('V3 lower hollow body shell created.')
    except:
        if ui:

"""Create the JJC V3 handle-to-body collar."""
...
def run(_context):
    ...
    try:
        ...
        if not isinstance(design, adsk.fusion.Design):
            ...
            return
        body = jjc_v3_parts.create_handle_to_body_collar(design.rootComponent)
        ui.activeSelections.clear()
        ui.activeSelections.add(body)
        ui.messageBox('V3 handle-to-body collar created.')
    except:
        if ui:

...
V3 keeps the compact V2 nose cap geometry to avoid adding unnecessary top mass.
...
The nose cap has a large effect on spin feel because it is far from the knob. Keep this part compact unless impact durability requires more material.

Estimated contribution:

```text
Mass: 10.0 g
Center: 495.0 mm from knob end
```
